...
exports.ConvertPositionRequest = void 0;
...
class ConvertPositionRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('new_product')) obj.newProduct = _ApiClient.ApiClient.convertToType(data['new_product'], 'String');
      if (data.hasOwnProperty('old_product')) obj.oldProduct = _ApiClient.ApiClient.convertToType(data['old_product'], 'String');
 ...
 */
exports.ConvertPositionRequest = ConvertPositionRequest;
