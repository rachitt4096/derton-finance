...
exports.TradeWiseMetaData = void 0;
...
class TradeWiseMetaData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('trades_count')) obj.tradesCount = _ApiClient.ApiClient.convertToType(data['trades_count'], 'Number');
      if (data.hasOwnProperty('page_size_limit')) obj.pageSizeLimit = _ApiClient.ApiClient.convertToType(data['page_size_limit'], 'Number');
    }
    return obj;
  }
}
 ...
 */
exports.TradeWiseMetaData = TradeWiseMetaData;
