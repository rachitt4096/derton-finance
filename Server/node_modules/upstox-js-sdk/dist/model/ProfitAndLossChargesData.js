...
exports.ProfitAndLossChargesData = void 0;
var _ApiClient = require("../ApiClient");
var _ProfitAndLossChargesTaxes = require("./ProfitAndLossChargesTaxes");
var _ProfitAndLossOtherChargesTaxes = require("./ProfitAndLossOtherChargesTaxes");
/*
...
class ProfitAndLossChargesData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('brokerage')) obj.brokerage = _ApiClient.ApiClient.convertToType(data['brokerage'], 'Number');
      if (data.hasOwnProperty('taxes')) obj.taxes = _ProfitAndLossChargesTaxes.ProfitAndLossChargesTaxes.constructFromObject(data['taxes']);
      if (data.hasOwnProperty('charges')) obj.charges = _ProfitAndLossOtherChargesTaxes.ProfitAndLossOtherChargesTaxes.constructFromObject(data['charges']);
    }
    return obj;
  }
}
 ...
 * @member {Number} total
 */
exports.ProfitAndLossChargesData = ProfitAndLossChargesData;
