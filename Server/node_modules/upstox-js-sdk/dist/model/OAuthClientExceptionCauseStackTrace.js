...
exports.OAuthClientExceptionCauseStackTrace = void 0;
 ...
 * @version v2
 */
class OAuthClientExceptionCauseStackTrace {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('classLoaderName')) obj.classLoaderName = _ApiClient.ApiClient.convertToType(data['classLoaderName'], 'String');
      if (data.hasOwnProperty('moduleName')) obj.moduleName = _ApiClient.ApiClient.convertToType(data['moduleName'], 'String');
      if (data.hasOwnProperty('moduleVersion')) obj.moduleVersion = _ApiClient.ApiClient.convertToType(data['moduleVersion'], 'String');
      if (data.hasOwnProperty('methodName')) obj.methodName = _ApiClient.ApiClient.convertToType(data['methodName'], 'String');
      if (data.hasOwnProperty('fileName')) obj.fileName = _ApiClient.ApiClient.convertToType(data['fileName'], 'String');
      if (data.hasOwnProperty('lineNumber')) obj.lineNumber = _ApiClient.ApiClient.convertToType(data['lineNumber'], 'Number');
      if (data.hasOwnProperty('className')) obj.className = _ApiClient.ApiClient.convertToType(data['className'], 'String');
      if (data.hasOwnProperty('nativeMethod')) obj.nativeMethod = _ApiClient.ApiClient.convertToType(data['nativeMethod'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
exports.OAuthClientExceptionCauseStackTrace = OAuthClientExceptionCauseStackTrace;
