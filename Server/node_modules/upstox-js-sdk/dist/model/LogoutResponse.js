...
class LogoutResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
LogoutResponse.prototype.status = undefined;

/**
 * Logout status
 * @member {Boolean} data
 */
LogoutResponse.prototype.data = undefined;