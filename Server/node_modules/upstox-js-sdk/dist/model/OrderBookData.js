...
class OrderBookData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('guid')) obj.guid = _ApiClient.ApiClient.convertToType(data['guid'], 'String');
      ...
      if (data.hasOwnProperty('placed_by')) obj.placedBy = _ApiClient.ApiClient.convertToType(data['placed_by'], 'String');
      ...
      if (data.hasOwnProperty('filled_quantity')) obj.filledQuantity = _ApiClient.ApiClient.convertToType(data['filled_quantity'], 'Number');
      if (data.hasOwnProperty('pending_quantity')) obj.pendingQuantity = _ApiClient.ApiClient.convertToType(data['pending_quantity'], 'Number');
      if (data.hasOwnProperty('status_message')) obj.statusMessage = _ApiClient.ApiClient.convertToType(data['status_message'], 'String');
      if (data.hasOwnProperty('status_message_raw')) obj.statusMessageRaw = _ApiClient.ApiClient.convertToType(data['status_message_raw'], 'String');
      ...
      if (data.hasOwnProperty('variety')) obj.variety = _ApiClient.ApiClient.convertToType(data['variety'], 'String');
      ...
      if (data.hasOwnProperty('order_request_id')) obj.orderRequestId = _ApiClient.ApiClient.convertToType(data['order_request_id'], 'String');
