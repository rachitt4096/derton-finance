...
class OhlcV3 {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OhlcV3();
      if (data.hasOwnProperty('open')) obj.open = _ApiClient.ApiClient.convertToType(data['open'], 'Number');
      if (data.hasOwnProperty('high')) obj.high = _ApiClient.ApiClient.convertToType(data['high'], 'Number');
      if (data.hasOwnProperty('low')) obj.low = _ApiClient.ApiClient.convertToType(data['low'], 'Number');
      if (data.hasOwnProperty('close')) obj.close = _ApiClient.ApiClient.convertToType(data['close'], 'Number');
      if (data.hasOwnProperty('volume')) obj.volume = _ApiClient.ApiClient.convertToType(data['volume'], 'Number');
      if (data.hasOwnProperty('ts')) obj.ts = _ApiClient.ApiClient.convertToType(data['ts'], 'Number');
    }
    return obj;
  }
}
