...
exports.GetTradeWiseProfitAndLossDataResponse = void 0;
var _ApiClient = require("../ApiClient");
var _ProfitAndLossMetaDataWrapper = require("./ProfitAndLossMetaDataWrapper");
var _TradeWiseProfitAndLossData = require("./TradeWiseProfitAndLossData");
/*
...
class GetTradeWiseProfitAndLossDataResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_TradeWiseProfitAndLossData.TradeWiseProfitAndLossData]);
      if (data.hasOwnProperty('metadata')) obj.metadata = _ProfitAndLossMetaDataWrapper.ProfitAndLossMetaDataWrapper.constructFromObject(data['metadata']);
    }
    return obj;
  }
}
 ...
 * @readonly
 */
exports.GetTradeWiseProfitAndLossDataResponse = GetTradeWiseProfitAndLossDataResponse;
