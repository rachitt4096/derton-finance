...
class UserApi {
  ...
  */
  ...
  getProfile(apiVersion, callback) {
    ...
    let returnType = _GetProfileResponse.GetProfileResponse;
    return this.apiClient.callApi('/v2/user/profile', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getUserFundMargin(apiVersion, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetUserFundMarginResponse.GetUserFundMarginResponse;
    return this.apiClient.callApi('/v2/user/get-funds-and-margin', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
