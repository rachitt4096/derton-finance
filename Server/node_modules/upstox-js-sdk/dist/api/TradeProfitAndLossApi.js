...
exports.TradeProfitAndLossApi = void 0;
...
class TradeProfitAndLossApi {
  ...
  */
  ...
  getProfitAndLossCharges(segment, financialYear, apiVersion, opts, callback) {
    ...
    let returnType = _GetProfitAndLossChargesResponse.GetProfitAndLossChargesResponse;
    return this.apiClient.callApi('/v2/trade/profit-loss/charges', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeWiseProfitAndLossData(segment, financialYear, pageNumber, pageSize, apiVersion, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetTradeWiseProfitAndLossDataResponse.GetTradeWiseProfitAndLossDataResponse;
    return this.apiClient.callApi('/v2/trade/profit-loss/data', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeWiseProfitAndLossMetaData(segment, financialYear, apiVersion, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetTradeWiseProfitAndLossMetaDataResponse.GetTradeWiseProfitAndLossMetaDataResponse;
    return this.apiClient.callApi('/v2/trade/profit-loss/metadata', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.TradeProfitAndLossApi = TradeProfitAndLossApi;