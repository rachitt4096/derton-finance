...
class HistoryV3Api {
  ...
  */
  ...
  getHistoricalCandleData(instrumentKey, unit, interval, toDate, callback) {
    ...
    return this.apiClient.callApi('/v3/historical-candle/{instrumentKey}/{unit}/{interval}/{to_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getHistoricalCandleData1(instrumentKey, unit, interval, toDate, fromDate, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _GetHistoricalCandleResponse.GetHistoricalCandleResponse;
    return this.apiClient.callApi('/v3/historical-candle/{instrumentKey}/{unit}/{interval}/{to_date}/{from_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getIntraDayCandleData(instrumentKey, unit, interval, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetIntraDayCandleResponse.GetIntraDayCandleResponse;
    return this.apiClient.callApi('/v3/historical-candle/intraday/{instrumentKey}/{unit}/{interval}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.HistoryV3Api = HistoryV3Api;