...
exports.ExpiredInstrumentApi = void 0;
...
class ExpiredInstrumentApi {
  ...
  */
  ...
  getExpiredFutureContracts(instrumentKey, expiryDate, callback) {
    ...
    let returnType = _GetExpiredFuturesContractResponse.GetExpiredFuturesContractResponse;
    return this.apiClient.callApi('/v2/expired-instruments/future/contract', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getExpiredHistoricalCandleData(expiredInstrumentKey, interval, toDate, fromDate, callback) {
    ...
    let pathParams = {
      'expired_instrument_key': expiredInstrumentKey,
      'interval': interval,
      'to_date': toDate,
      'from_date': fromDate
    };
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetHistoricalCandleResponse.GetHistoricalCandleResponse;
    return this.apiClient.callApi('/v2/expired-instruments/historical-candle/{expired_instrument_key}/{interval}/{to_date}/{from_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getExpiredOptionContracts(instrumentKey, expiryDate, callback) {
    ...
    return this.apiClient.callApi('/v2/expired-instruments/option/contract', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getExpiries(instrumentKey, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetExpiriesResponse.GetExpiriesResponse;
    return this.apiClient.callApi('/v2/expired-instruments/expiries', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.ExpiredInstrumentApi = ExpiredInstrumentApi;