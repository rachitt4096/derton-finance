...
exports.MarketQuoteV3Api = void 0;
...
class MarketQuoteV3Api {
  ...
  */
  ...
  getLtp(opts, callback) {
    ...
    let returnType = _GetMarketQuoteLastTradedPriceResponseV.GetMarketQuoteLastTradedPriceResponseV3;
    return this.apiClient.callApi('/v3/market-quote/ltp', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getMarketQuoteOHLC(interval, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetMarketQuoteOHLCResponseV.GetMarketQuoteOHLCResponseV3;
    return this.apiClient.callApi('/v3/market-quote/ohlc', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getMarketQuoteOptionGreek(opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetMarketQuoteOptionGreekResponseV.GetMarketQuoteOptionGreekResponseV3;
    return this.apiClient.callApi('/v3/market-quote/option-greek', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.MarketQuoteV3Api = MarketQuoteV3Api;