...
class OrderApi {
  ...
  */
   ...
   * @param {String} [algoName] Optional algorithm name to be sent as X-Algo-Name header
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  cancelMultiOrder(opts, callback, algoName) {
    opts = opts || {};
    let postBody = null;
    let pathParams = {};
    let queryParams = {
    ...
    // Add X-Algo-Name header if algoName is provided
    if (algoName !== undefined && algoName !== null) {
      headerParams['X-Algo-Name'] = algoName;
    }
    let formParams = {};
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  cancelOrder(orderId, apiVersion, callback, algoName) {
    let postBody = null;
  ...
  /**
       ...
       * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
       */
  exitPositions(opts, callback, algoName) {
    opts = opts || {};
    let postBody = null;
    let pathParams = {};
    let queryParams = {
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  placeMultiOrder(body, callback, algoName) {
    let postBody = body;
  ...
  mapToModifyOrderRequest(data) {
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('marketProtection')) obj.market_protection = _ApiClient.ApiClient.convertToType(data['marketProtection'], 'Number');
    }
    return obj;
  }
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  modifyOrder(body, apiVersion, callback, algoName) {
   ...
   * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
   */
  placeOrder(body, apiVersion, callback, algoName) {
