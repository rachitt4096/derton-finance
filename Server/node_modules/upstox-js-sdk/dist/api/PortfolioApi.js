  ...
  */
  ...
  mapToConvertPositionRequest(data) {
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('newProduct')) obj.new_product = _ApiClient.ApiClient.convertToType(data['newProduct'], 'String');
      if (data.hasOwnProperty('oldProduct')) obj.old_product = _ApiClient.ApiClient.convertToType(data['oldProduct'], 'String');
  ...
  convertPositions(body, apiVersion, callback) {
    ...
    let returnType = _ConvertPositionResponse.ConvertPositionResponse;
    return this.apiClient.callApi('/v2/portfolio/convert-position', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getHoldings(apiVersion, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*', 'application/json'];
    let returnType = _GetHoldingsResponse.GetHoldingsResponse;
    return this.apiClient.callApi('/v2/portfolio/long-term-holdings', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getMtfPositions(callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*', 'application/json'];
    let returnType = _GetPositionResponse.GetPositionResponse;
    return this.apiClient.callApi('/v3/portfolio/mtf-positions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getPositions(apiVersion, callback) {
    ...
    let accepts = ['*/*', 'application/json'];
    let returnType = _GetPositionResponse.GetPositionResponse;
    return this.apiClient.callApi('/v2/portfolio/short-term-positions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
