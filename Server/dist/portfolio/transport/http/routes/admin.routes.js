...
import { adminCreateUserSchema, adminResetPasswordSchema, adminUpdateUserSchema, } from '../../../lib/contracts.js';
import { requireAdminUser } from '../../../lib/httpAuth.js';
const sendAdminError = (reply, error) => {
...
export const registerAdminRoutes = (app, authService, adminService, marketRuntime, config) => {
